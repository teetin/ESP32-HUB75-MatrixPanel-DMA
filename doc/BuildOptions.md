...
| **HUB75_FORCE_GPIO** | Force the use of the GPIO bit-bang driver even on platforms that support DMA/I2S. | Useful for debugging or if the DMA driver is causing issues.
